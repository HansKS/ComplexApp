...
User.prototype.validate = function(){
    return new Promise(async (resolve, reject) => {
        ...
        if(this.data.username.length > 0 && this.data.username.length < 3){this.errors.push("Username should be at least 3 characters.")}
...
User.prototype.getAvatar = function(){
    this.avatar = `https://es.gravatar.com/avatar/${md5(this.data.email)}?s=128`
}
